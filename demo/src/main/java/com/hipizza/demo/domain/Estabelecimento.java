...
public class Estabelecimento {
    ...
    @Column(name = "DB101_EST_TELEFONE", length = 20)
    ...
    @Column(name = "DB101_EST_ENDERECO", length = 150)
    ...
    @Column(name = "DB101_EST_CNPJ", length = 14, unique = true)
    ...
    @Column(name = "DB101_EST_RAZAO_SOCIAL", length = 80)
